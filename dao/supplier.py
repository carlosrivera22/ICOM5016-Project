...
class SupplierDAO:
    ...
    def getSupplierByRegionId(self,region_id):
        cursor = self.conn.cursor()
        query = "select distinct first_name, last_name, company_name, region_id from account natural inner join supplier natural inner join supplies natural inner join distribution_region where region_id = %s;"
